...
from A2_image_preprocessing import A2_CNN_SVM_load_mouth_images
...
X_train, y_train = A2_CNN_SVM_load_mouth_images(train_basedir, train_labels_filename, train_images_dir)
X_test, y_test = A2_CNN_SVM_load_mouth_images(test_basedir, test_labels_filename, test_images_dir)
