...
def train(train_dataloader):
    ...
    # # Save neural network
    torch.save(net, 'D:/Nottingham/FYP_Chenhao Shi/AMLS_Assignment2022_23_SN22073551/Good models and results/A2_mouth_CNN.pkl')


def test_accuracy_rate(test_dataloader, test_batch_size):
    module = torch.load('D:/Nottingham/FYP_Chenhao Shi/AMLS_Assignment2022_23_SN22073551/Good models and results/A2_mouth_CNN.pkl')
    module.eval()
