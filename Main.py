...
sys.path.append('B2')
import os
from A1 import A1_CNN
from A2 import A2_CNN_face_recognition, A2_CNN_mouth
from B1 import B1_CNN
from B2 import B2_Eyes_color_recognition_CNN
...
print('Starting A1-method 1: CNN with full image...')
train_dataloader_A1, test_dataloader_A1 = A1_CNN_dataloader()
# Train CNN model
# A1_CNN.train(train_dataloader_A1)
# Show examples of processed images and classification results
# A1_CNN.test_image_examples(test_dataloader_A1, A1_classes, test_batch_size_A1)
# Test the classification accuracy
A1_CNN.test_accuracy_rate(test_dataloader_A1, test_batch_size_A1)
print('------------------------------------------------------------------------')
# ------------------------------------------------------------------------------------------------
# Method 2 - Logistic Regression with full image
print('Starting A1-method 2: Logistic Regression with full image...')
img_size = 128
...
# Train CNN model
# A2_CNN_face_recognition.train(train_dataloader1)
# Show examples of processed images and classification results
# A2_CNN_face_recognition.test_image_examples(test_dataloader1, A2_classes, test_batch_size_A2)
# Test the classification accuracy
A2_CNN_face_recognition.test_accuracy_rate(test_dataloader1, test_batch_size_A2)
print('------------------------------------------------------------------------')
# ------------------------------------------------------------------------------------------------
...
# Train CNN model
# A2_CNN_mouth.train(train_dataloader2)
# Show examples of processed images and classification results
# A2_CNN_mouth.test_image_examples(test_dataloader2, A2_classes, test_batch_size_A2)
# Test the classification accuracy
A2_CNN_mouth.test_accuracy_rate(test_dataloader2, test_batch_size_A2)
print('------------------------------------------------------------------------')
# ------------------------------------------------------------------------------------------------
...
# Train the CNN model
# B1_CNN.train(train_dataloader_B1)
# Show examples of processed images and classification results
# B1_CNN.test_image_examples(test_dataloader_B1, B1_classes, test_batch_size_B1)
# Test the classification accuracy
B1_CNN.test_accuracy_rate(test_dataloader_B1, test_batch_size_B1)
print('------------------------------------------------------------------------')
# ------------------------------------------------------------------------------------------------
...
# Train CNN model
# B2_Eyes_color_recognition_CNN.train(train_dataloader_B2)
# Show examples of processed images and classification results
# B2_Eyes_color_recognition_CNN.test_image_examples(test_dataloader_B2, B2_classes, test_batch_size_B2)
# Test the classification accuracy
B2_Eyes_color_recognition_CNN.test_accuracy_rate(test_dataloader_B2, test_batch_size_B2)